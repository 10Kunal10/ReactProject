    ...
    return (
      <div>
        ...
        <Route exact path="/" element={<News key="general" pageSize={15} country="in" category="general"/>}></Route>
          <Route exact path="/business" element={<News key="business" pageSize={15} country="in" Color="red" category="business"/>}></Route>
          ...
          <Route exact path="/sports" element={<News key="sport" pageSize={15} country="in" category="sports"/>}></Route>
